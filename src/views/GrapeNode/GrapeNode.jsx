            ...
            <>
                    ...
                    <Card className={classes.gridItem}>
                      <CardContent style={{ textAlign: 'center' }}>
                        ...
                        <Typography>
                          {nodes[0] && (
                            <>
                              <span style={{ color: 'rgb(0, 0, 0)', marginRight: '0px' }}>{nodes[0].toString()}</span> |{' '}
              ...
              <Box mt={5}>
                <StyledBank>
                  <StyledCardsWrapper>
                    <StyledCardWrapper>
                      <Harvest disabled={bank.depositTokenName === 'ASHARE' && Number(total[0]) > 8299} bank={bank} />
                    </StyledCardWrapper>
                    <Spacer />
                    <StyledCardWrapper>
                      {<Stake disabled={bank.depositTokenName === 'ASHARE' && Number(total[0]) > 8299} bank={bank} />}
                    </StyledCardWrapper>
                  </StyledCardsWrapper>
                  <Spacer size="lg" />
                </StyledBank>
